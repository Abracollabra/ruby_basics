...
# LS Solution: # Full Explanation follows at the end.
...
# puts "Hi, friend! Do you want me to print something? \nPlease reply either with either a y or an n."
...
#     break
#   else 
#    puts "Happy to comply, but I just need either \"y\" or \"n\" as a reply."
#   end
# end
